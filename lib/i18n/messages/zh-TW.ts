...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "process.notice.success": "行程已結束",
    "process.notice.failure": "行程失敗",
    "process.notice.crash": "行程崩潰",
    "process.notice.killed": "行程被終止",
    "process.notice.log_match": "符合日誌關鍵字",
    "process.notice.log_match_suppressed": "符合日誌關鍵字（已抑制通知）",
    "process.exitCode": "結束碼 {code}",
    "process.endReason": "結束原因 {reason}",
    "process.signal": "訊號 {name} {number}",
    "process.elapsedSeconds": "{seconds} 秒",
    "process.elapsedMinutes": "{minutes} 分 {seconds} 秒",
    "process.pattern": "關鍵字 {pattern}",
    "process.stream": "來自 {stream}",
    "process.widgetTitle": "行程",
    "process.widgetRunning": "行程 · {count} 個執行中",
    "process.stateRunning": "執行中",
    "process.stateDone": "已完成",
    "process.stateTerminated": "已終止",
    "process.stateFailed": "失敗",
    "process.doneCount": "{count} 個已完成",
    ...
    "chat.voiceTranscribing": "正在轉寫…",
    "chat.voiceUnsupported": "目前瀏覽器無法錄音",
    "chat.voicePermission": "麥克風權限被拒絕，請在瀏覽器設定中允許後重試。",
    "chat.voiceEmpty": "沒有辨識到語音內容",
    "chat.voiceTooLong": "錄音太長，超過目前模型的上限，請分段錄製",
    "chat.voiceNotConfigured": "本機語音轉寫還沒準備好（缺 pi-transcribe 外掛或模型）",
    "chat.voiceFailed": "語音轉寫失敗",
