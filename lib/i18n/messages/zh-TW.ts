...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.reasoning": "深度思考",
    "trace.thoughtForSeconds": "思考了 {seconds} 秒",
    "trace.editedFiles": "編輯了 {count} 個檔案",
    "trace.ranCommands": "執行了 {count} 個指令",
    "trace.readFiles": "查看了 {count} 個檔案",
    "trace.actions": "執行了 {count} 個動作",
    "trace.expand": "查看過程",
    "trace.collapse": "收合",
