...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "trace.thoughtForSeconds": "Thought for {seconds}s",
    "trace.editedFiles": "Edited {count} files",
    "trace.ranCommands": "Ran {count} commands",
    "trace.readFiles": "Read {count} files",
    "trace.actions": "Ran {count} actions",
    "trace.expand": "Show steps",
    "trace.collapse": "Hide",
