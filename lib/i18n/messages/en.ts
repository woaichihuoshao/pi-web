...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "process.notice.success": "Process finished",
    "process.notice.failure": "Process failed",
    "process.notice.crash": "Process crashed",
    "process.notice.killed": "Process was terminated",
    "process.notice.log_match": "Log pattern matched",
    "process.notice.log_match_suppressed": "Log pattern matched (notification suppressed)",
    "process.exitCode": "exit code {code}",
    "process.endReason": "end reason {reason}",
    "process.signal": "signal {name} {number}",
    "process.elapsedSeconds": "{seconds}s",
    "process.elapsedMinutes": "{minutes}m {seconds}s",
    "process.pattern": "pattern {pattern}",
    "process.stream": "on {stream}",
    "process.widgetTitle": "Processes",
    "process.widgetRunning": "Processes · {count} running",
    "process.stateRunning": "running",
    "process.stateDone": "done",
    "process.stateTerminated": "terminated",
    "process.stateFailed": "failed",
    "process.doneCount": "{count} done",    "chat.outputLocal": "output stays local",
    ...
    "chat.voiceUnsupported": "This browser cannot record audio",
    "chat.voicePermission": "Microphone access was blocked. Allow it in your browser settings and try again.",
    "chat.voiceEmpty": "No speech detected",
    "chat.voiceTooLong": "Recording is longer than this model accepts; record it in shorter takes",
    "chat.voiceNotConfigured": "Local transcription is not ready — install the pi-transcribe extension and pick a model",
    "chat.voiceFailed": "Transcription failed",
