...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "process.notice.success": "进程已结束",
    "process.notice.failure": "进程失败",
    "process.notice.crash": "进程崩溃",
    "process.notice.killed": "进程被终止",
    "process.notice.log_match": "匹配到日志关键字",
    "process.notice.log_match_suppressed": "匹配到日志关键字（已抑制通知）",
    "process.exitCode": "退出码 {code}",
    "process.endReason": "结束原因 {reason}",
    "process.signal": "信号 {name} {number}",
    "process.elapsedSeconds": "{seconds} 秒",
    "process.elapsedMinutes": "{minutes} 分 {seconds} 秒",
    "process.pattern": "关键字 {pattern}",
    "process.stream": "来自 {stream}",
    "process.widgetTitle": "进程",
    "process.widgetRunning": "进程 · {count} 个运行中",
    "process.stateRunning": "运行中",
    "process.stateDone": "已完成",
    "process.stateTerminated": "已终止",
    "process.stateFailed": "失败",
    "process.doneCount": "{count} 个已完成",
    ...
    "chat.voiceTranscribing": "正在转写…",
    "chat.voiceUnsupported": "当前浏览器无法录音",
    "chat.voicePermission": "麦克风权限被拒绝，请在浏览器设置中允许后重试。",
    "chat.voiceEmpty": "没有识别到语音内容",
    "chat.voiceTooLong": "录音太长，超过当前模型的上限，请分段录制",
    "chat.voiceNotConfigured": "本机语音转写还没准备好（缺 pi-transcribe 插件或模型）",
