...
export function AppShell() {
        ...
        {(() => {
          ...
          return (
            <button
              ...
              onMouseEnter={(event) => {
                if (disabled) return;
                event.currentTarget.style.color = isError ? "var(--state-danger)" : "var(--text)";
                event.currentTarget.style.background = "var(--bg-hover)";
              }}
              onMouseLeave={(event) => {
                event.currentTarget.style.color = isError ? "var(--state-danger)" : isSuccess ? "var(--accent)" : disabled ? "var(--text-dim)" : "var(--text-muted)";
                event.currentTarget.style.background = "none";
              }}
  ...
  const renderSessionStatsButton = (mobile: boolean) => {
    ...
    if (contextUsage?.contextWindow) {
      ...
      if (percent !== null && percent > 90) contextColor = "var(--state-danger)";
        ...
        <div style={{ display: "flex", alignItems: "center", position: "relative", borderBottom: "1px solid var(--border)", height: "calc(36px + env(safe-area-inset-top))", paddingTop: "env(safe-area-inset-top)" }}>
          <button
            ...
            style={{
              display: "flex", alignItems: "center", justifyContent: "center",
              width: TOP_BAR_ICON_BUTTON_SIZE, height: TOP_BAR_ICON_BUTTON_SIZE, padding: 0,
              background: "none", border: "none", borderRight: "var(--divider)",
              ...
              {isNarrowMobile && (
                <button
                  ...
                  style={{
                    ...
                    border: "none", borderRight: "var(--divider)",
